...
\begin{table*}[t]
\centering
\caption{High-level comparison of settlement architectures}
\label{tab:cns-rtgs-dlt}
\setlength{\tabcolsep}{6pt}
\renewcommand{\arraystretch}{1.15}
\begin{tabularx}{\textwidth}{lXXX}
\toprule
\textbf{Aspect} & \textbf{CNS} & \textbf{RTGS} & \textbf{DLT / Ledger-Based} \\
\midrule
Settlement principle 
& Multilateral netting over time 
& Immediate gross settlement 
& Ledger-based transaction finalization \\

Primary state abstraction 
& Net obligations 
& Account balances 
& Distributed ledger \\

Timing model 
& Discrete settlement cycles 
& Continuous / event-driven 
& Discrete rounds or blocks \\

Liquidity profile 
& Liquidity-efficient via netting 
& Liquidity-intensive 
& Design-dependent \\

Handling of shortfalls or failures 
& Obligations roll forward 
& Transactions queue or fail 
& Protocol-defined resolution \\

Control and policy flexibility 
& Explicit, configurable policies 
& Limited, rule-based 
& Embedded in protocol \\

Formal modeling perspective 
