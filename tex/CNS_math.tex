...
This paper should be read as a \emph{structural reconstruction} of CNS-style continuous net settlement: a reference specification that makes the core mechanics explicit and analyzable as a state--transition system. While the model is informed by publicly described clearing workflows (e.g., in the NSCC/DTCC context), it is not intended as a line-by-line reproduction of any proprietary implementation or rulebook, and omits institution-specific exceptions, timelines, and operational procedures. Instead, the goal is to capture the essential invariants, admissibility interfaces, and allocation degrees of freedom in a form suitable for simulation, comparison, and formal reasoning.
